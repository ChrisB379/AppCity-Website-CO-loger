 ...
 * 
 * It is used to get and store cookies which contain information about which stylesheet is to be used
 * so when a user selects a stylesheet it will remain the same one even when they load a new page
 * since the cookie saves the users preference
 */
